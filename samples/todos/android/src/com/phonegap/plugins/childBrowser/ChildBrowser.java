    ...
    */
    ...
    public String openExternal(String url, boolean usePhoneGap) {
        try {
            Intent intent = null;
            if (usePhoneGap) {
                intent = new Intent().setClass((Context) this.ctx, DroidGap.class);
    ...
    */
    ...
    public String showWebPage(final String url, JSONObject options) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                dialog = new Dialog((Context) ctx, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
                ...
                */
                ...
                TextView title = new TextView((Context) ctx);
                title.setId(1);
                ...
                childWebView = new WebView((Context) ctx);
