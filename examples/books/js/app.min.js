...
define('lavaca/mvc/View',['require','$','lavaca/events/EventDispatcher','lavaca/mvc/Model','lavaca/ui/Template','lavaca/util/Cache','lavaca/util/Promise','lavaca/util/log','lavaca/util/uuid','mout/lang/deepClone'],function(require) {
...
define('rdust!templates/books',['dust'],function(dust){(function(){dust.register("templates/books",body_0);function body_0(chk,ctx){return chk.write("<div id=\"searchBar\"></div><div id=\"bookContainer\"></div>");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/books', context, callback)}}});
define('app/models/StateModel',['require','lavaca/mvc/Model'],function(require) {
  var Model = require('lavaca/mvc/Model');

  return new Model();
});
define('rdust!templates/search',['dust'],function(dust){(function(){dust.register("templates/search",body_0);function body_0(chk,ctx){return chk.write("Search : <input type=\"text\" name=\"search\" autocomplete=\"off\" id=\"searchTerm\" value=\"\" /><img src=\"assets/img/books/loader.gif\" alt=\"Loading...\" id=\"spinner\" />");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/search', context, callback)}}});
define('app/ui/views/childviews/SearchView',['require','lavaca/mvc/View','app/models/StateModel','rdust!templates/search'],function(require) {
...
define('app/models/SearchModel',['require','lavaca/mvc/Model'],function(require) {
  var Model = require('lavaca/mvc/Model');
...
define('rdust!templates/book-detail',['dust'],function(dust){(function(){dust.register("templates/book-detail",body_0);function body_0(chk,ctx){return chk.write("<a class=\"close\" data-dismiss=\"modal\">x</a><div class=\"imgBook\"><img src=\"").exists(ctx.getPath(false,["volumeInfo","imageLinks","thumbnail"]),ctx,{"else":body_1,"block":body_2},null).write("\" /></div><h1>").reference(ctx.get("title"),ctx,"h").write("</h1>").exists(ctx.getPath(false,["volumeInfo","subtitle"]),ctx,{"block":body_3},null).exists(ctx.getPath(false,["volumeInfo","description"]),ctx,{"else":body_4,"block":body_5},null).write("<div><p>Google link :</p> <a href=\"http://books.google.fr/books?id=").reference(ctx.get("id"),ctx,"h").write("\" target=\"_blank\">http://books.google.fr/books?id=").reference(ctx.get("id"),ctx,"h").write("</a></div><div class=\"favorite\">").exists(ctx.get("isFavorite"),ctx,{"else":body_6,"block":body_7},null).write("</div>");}function body_1(chk,ctx){return chk.write("http://placehold.it/200x260");}function body_2(chk,ctx){return chk.reference(ctx.getPath(false,["volumeInfo","imageLinks","thumbnail"]),ctx,"h");}function body_3(chk,ctx){return chk.write("<h2>").reference(ctx.getPath(false,["volumeInfo","subtitle"]),ctx,"h").write("</h2>");}function body_4(chk,ctx){return chk.write("</p>No description found.</p>");}function body_5(chk,ctx){return chk.write("<p>").reference(ctx.getPath(false,["volumeInfo","description"]),ctx,"h").write("</p>");}function body_6(chk,ctx){return chk.write("<span class=\"add\">Add to favorites</span>");}function body_7(chk,ctx){return chk.write("<span class=\"remove\">Remove from favorites</span>");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/book-detail', context, callback)}}});
define('app/ui/views/childviews/BookDetailView',['require','lavaca/mvc/View','app/models/StateModel','rdust!templates/book-detail'],function(require) {
...
define('rdust!templates/book-item',['dust'],function(dust){(function(){dust.register("templates/book-item",body_0);function body_0(chk,ctx){return chk.write("<img src=\"").exists(ctx.getPath(false,["volumeInfo","imageLinks","thumbnail"]),ctx,{"else":body_1,"block":body_2},null).write("\" alt=\"").reference(ctx.getPath(false,["volumeInfo","title"]),ctx,"h").write("\" class=\"book\" />");}function body_1(chk,ctx){return chk.write("http://placehold.it/100x150");}function body_2(chk,ctx){return chk.reference(ctx.getPath(false,["volumeInfo","imageLinks","thumbnail"]),ctx,"h");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/book-item', context, callback)}}});
define('app/ui/views/childviews/BookItemView',['require','lavaca/mvc/View','app/ui/views/childviews/BookDetailView','app/models/StateModel','rdust!templates/book-item'],function(require) {
...
define('app/models/BookModel',['require','lavaca/mvc/Model'],function(require) {
  var Model = require('lavaca/mvc/Model');
...
define('rdust!templates/book-list',['dust'],function(dust){(function(){dust.register("templates/book-list",body_0);function body_0(chk,ctx){return chk.write("<div id=\"bookList\" class=\"table-striped table-bordered\"><div style=\"display:table;width:100%;height:100%;\"><div class=\"leftBar\"><img src=\"assets/img/books/shadow-search.png\" style=\"position:absolute;left: 0px;top: 0px;\"/></div><div class=\"books\"></div><div class=\"rightBar\"><img src=\"assets/img/books/shadow-search-right.png\" style=\"position:absolute;right: 0px;top: 0px;\"/></div></div></div>");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/book-list', context, callback)}}});
define('app/ui/views/childViews/BookCollectionView',['require','lavaca/mvc/View','app/ui/views/childviews/BookItemView','app/models/BookModel','mout/lang/deepClone','app/models/StateModel','rdust!templates/book-list'],function(require) {
...
define('app/collections/BookCollection',['require','lavaca/mvc/Collection','app/models/BookModel','app/models/StateModel','lavaca/util/Config'],function(require) {
...
define('app/ui/views/BooksView',['require','./BaseView','rdust!templates/books','lavaca/util/Config','./childviews/SearchView','../../models/SearchModel','./childViews/BookCollectionView','../../collections/BookCollection'],function(require) {
...
define('rdust!templates/favorites',['dust'],function(dust){(function(){dust.register("templates/favorites",body_0);function body_0(chk,ctx){return chk.write("<div id=\"searchBar\"></div><div id=\"bookContainer\"><div id=\"bookList\" class=\"table-striped table-bordered\"><div style=\"display:table;width:100%;height:100%;\"><img src=\"assets/img/books/shadow-search.png\" style=\"position:absolute;left: 0px;top: 0px;\"/><img src=\"assets/img/books/shadow-search-right.png\" style=\"position:absolute;right: 0px;top: 0px;\"/><div class=\"leftBar\"></div><div class=\"books\"></div><div class=\"rightBar\"></div></div></div></div>");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/favorites', context, callback)}}});
define('app/ui/views/FavoritesView',['require','./BaseView','app/ui/views/childviews/BookItemView','mout/function/debounce','rdust!templates/favorites','lavaca/util/Config'],function(require) {
...
define('app/collections/FavoriteCollection',['require','lavaca/mvc/Collection','app/models/BookModel','app/models/StateModel','mout/function/debounce'],function(require) {
  var Collection = require('lavaca/mvc/Collection');
  var BookModel = require('app/models/BookModel');
  var stateModel = require('app/models/StateModel');
  var debounce = require('mout/function/debounce');
...
define('app/net/BookController',['require','app/ui/views/BooksView','app/ui/views/FavoritesView','app/collections/FavoriteCollection','app/net/BaseController','lavaca/util/Translation','app/cache/localStore','app/models/StateModel'],function(require) {
...
define('app/ui/views/controls/ModalView',['require','lavaca/mvc/View','bootstrap','app/models/StateModel'],function(require) {
...
define('rdust!templates/menu',['dust'],function(dust){(function(){dust.register("templates/menu",body_0);function body_0(chk,ctx){return chk.write("<a href=\"/\" class=\"js-menu-search\">Search</a><a href=\"/favorites\" class=\"js-menu-favorites\">Favorites</a>");}return body_0;})(); return {render: function(context, callback) {return dust.render('templates/menu', context, callback)}}});
define('app/ui/views/controls/MenuView',['require','lavaca/mvc/View','app/models/StateModel','rdust!templates/menu'],function(require) {
...
define('app/mvc/BooksApplication',['require','lavaca/mvc/Application','jquery'],function(require) {
...
define('app/app',['require','lavaca/net/History','lavaca/util/Config','lavaca/env/Detection','./net/BookController','app/ui/views/controls/ModalView','app/ui/views/controls/MenuView','lavaca/net/Connectivity','app/mvc/BooksApplication','lavaca/util/Translation','./cache/localStore','app/models/StateModel','lavaca/ui/DustTemplate','jquery-mobile/events/touch','jquery-mobile/events/orientationchange'],function(require) {
